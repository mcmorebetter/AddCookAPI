...
public class CookEndAction implements Action {
    public CookEndAction(ActionManager am, Player player, FurnitureEntity furnitureEntity, FurnitureData furnitureData,
    ...
    private void cookReset(Player player, FurnitureEntity furnitureEntity) {
        throw new AddCookNotFoundException();
    }
}
