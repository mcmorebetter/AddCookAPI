...
/**
 * 요리 재료 모델을 불러오는 Action 클래스
 */
public class FurnitureModelAction implements Action {
    public FurnitureModelAction(ActionManager am, Player player, FurnitureEntity furnitureEntity, FurnitureData furnitureData) {
