...
public class PartRemoveAction implements Action {
    public PartRemoveAction(ActionManager am, Player player, FurnitureEntity furnitureEntity, FurnitureData furnitureData) {
