...
public class CookFailEvent extends Event implements Cancellable {
    public CookFailEvent(Player player, FurnitureEntity furnitureEntity, @Nullable RecipeData recipeData, List<Line> lineList) {
