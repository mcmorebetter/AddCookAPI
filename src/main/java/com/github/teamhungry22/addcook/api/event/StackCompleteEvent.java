...
public class StackCompleteEvent extends Event implements Cancellable {
    public StackCompleteEvent(Player player, FurnitureEntity furnitureEntity, @Nullable RecipeData recipeData, List<Line> lineList) {
