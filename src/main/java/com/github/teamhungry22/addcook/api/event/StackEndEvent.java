...
public class StackEndEvent extends Event implements Cancellable {
    public StackEndEvent(Player player, FurnitureEntity furnitureEntity, @Nullable RecipeData recipeData, CookResult result, List<Line> lineList) {
