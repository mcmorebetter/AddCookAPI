...
public class CookCompleteEvent extends Event implements Cancellable {
    public CookCompleteEvent(Player player, FurnitureEntity furnitureEntity, @Nullable RecipeData recipeData, List<Line> lineList) {
